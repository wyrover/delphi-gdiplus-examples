...
var
  ...
  colorMap : array[0..0] of TColorMap;
begin
  graphics := TGPGraphics.Create(DC);

  Image := TGPImage.Create('..\..\Media\colortrans.PNG');
  ImageAttributes := TGPImageAttributes.Create;
  width  := Image.GetWidth;
  height := Image.GetHeight;

  colorMap[0].oldColor := MakeColor(255, 255, 0, 0);  // opaque red
  colorMap[0].newColor := MakeColor(255, 0, 0, 255);  // opaque blue
...
begin
   ...
   hWnd := CreateWindow(
      ...
      'Using a Color Remap Table',      // window caption

...
begin
  ...
  Pen := TGPPen.Create(MakeColor(255, 0, 0, 0),5);  // opaque green
  graphics.SetSmoothingMode(SmoothingModeAntiAlias);
  graphics.DrawEllipse(pen, 5, 5, 200, 100);
  graphics.SetSmoothingMode(SmoothingModeHighSpeed);
  graphics.DrawEllipse(pen, 5, 150, 200, 100);
  Pen.Free;
  graphics.Free;
end;
...
begin
   ...
   hWnd := CreateWindow(
      ...
      'Quality Settings',      // window caption

...
begin
  ...
  graphics.DrawCurve(pen, PGPPoint(@points), 5, 0.0); // tension 0.0
  graphics.DrawCurve(pen, PGPPoint(@points), 5, 0.6); // tension 0.6
  graphics.DrawCurve(pen, PGPPoint(@points), 5, 1.0); // tension 1.0
  Pen.Free;
  graphics.Free;
end;
